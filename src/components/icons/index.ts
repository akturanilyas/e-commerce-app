...
export { default as BankOffice } from './BankOffice';
...
export { default as RightLeftCircuit } from './RightLeftCircuit';
...
export { default as UploadReceipt } from './UploadReceipt';
